...
public class UserListFragment extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*for(UserLocation userLocation: mUserLocations){
            ...
            Log.d(TAG, "onCreateView: geo point: " + userLocation.getGeo_point().getLatitude() + ", " +
    ...
    public void onInfoWindowClick(final Marker marker) {
     /*   if (marker.getSnippet().equals("This is you")) {
       ...
       AlertDialog dialog = new AlertDialog.Builder(getActivity()).setMessage("Waleed").setTitle("YousifWaleed")
